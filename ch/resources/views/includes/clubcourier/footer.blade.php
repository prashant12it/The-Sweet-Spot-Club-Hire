        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-8">
                    <p class="copwrite">© Copyright {{date('Y')}} - The Sweet Spot Club Courier</p>
                </div>
                <div class="col-sm-4 col-md-4">
                    <span class="terms"><a href="{{url('../clubcourier-privacy-policy/')}}">Privacy Policy</a><a href="{{url('../terms-of-service-tssclubcourier/')}}">Terms of Service</a></span>
                </div>
            </div>
        </div>
    </div>
