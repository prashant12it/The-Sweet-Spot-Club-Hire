        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <p class="copwrite">© Copyright {{date('Y')}} - The Sweet Spot Golf Club Hire</p>
                </div>
                <div class="col-sm-6 col-md-6">
							<span>
								<ul id="socket">
									<li><a target=_blank" href="https://twitter.com/tssclubhire?lang=en"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
									<li><a target="_blank" href="https://www.facebook.com/tssclubhire/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
									<li><a target="_blank" href="https://www.instagram.com/tssclubhire/?hl=en"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
									<li><a target="_blank" href="https://www.youtube.com/channel/UCSE484gOqNWs5l2cVkuPEAw"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
								</ul>
							</span>
                    <span class="terms"><a href="{{url('../privacy-policy/')}}">Privacy Policy</a><a href="{{url('../terms-of-service/')}}">Terms of Service</a></span>
                </div>
            </div>
        </div>
    </div>
