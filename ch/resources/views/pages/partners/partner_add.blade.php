    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
           <ol class="breadcrumb">
                ...
                <li class="crumb-active">Add Partner Account</li>
            </ol>
        </ol>
    </div>
</header>
<section id="content">
    <div class="panel">
        ...
        <div class="panel-heading">
            <span class="panel-title">Add New Partner</span>
        </div>
        <form method="POST" enctype="multipart/form-data" action="{{ url('/add_partner') }}" class="form-horizontal" role="form" id="addPartnerForm">
            <div class="panel-body">
                ...
                <div class="panel-body p25 bg-light">
                    ...
                    <div class="section row form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="gui-input form-control" required="required" placeholder="Please type email...">
                            @if ($errors->has('email'))
                            <span class="help-block err">
                    ...
                    <div class="section row form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="password" id="password" value="{{ old('password') }}" class="gui-input form-control" required="required" placeholder="Please type password...">
                    ...
                    <div class="section row form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="contact_no" id="contact_no" value="{{ old('contact_no') }}" class="gui-input form-control" placeholder="Please type contact number...">
