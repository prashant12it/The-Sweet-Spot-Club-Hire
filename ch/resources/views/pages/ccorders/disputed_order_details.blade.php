        ...
        <div class="panel">
            <div class="panel mb25 mt5">
                ...
                <span class="panel-title hidden-xs">
                    <strong> Order Reference ID</strong> #{{$orderDetails->order_reference_id}}
                </span>
                ...
                <div class="panel-footer clearfix">
                    ...
                    <div class="col-md-2"><a href="{{ url('/club_courier_disputed_orders') }}" class="button form-control btn-info pull-right"><i class="fa fa-reply" aria-hidden="true"></i> Back to Orders</a></div>
                </div>
            </div>
        </div>
    </section>
