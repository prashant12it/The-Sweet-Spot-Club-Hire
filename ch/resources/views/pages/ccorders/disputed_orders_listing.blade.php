        ...
        <div class="topbar-left">
            <ol class="breadcrumb">
                <li class="crumb-active">
                    <a href="{{url('/club_courier_disputed_orders')}}"><span class="glyphicon glyphicon-shopping-cart"></span> Club Courier Disputed Orders</a>
                </li>
            </ol>
        </div>
    </header>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="navbar-btn btn-group">
                                            <a href="{{ url('/view_club_courier_disputed_orders') }}/{{$oderDetails->id}}" class="button form-control btn-info" title="View Order Details">
            ...
            <div class="modal fade" id="updateStatusModal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <form method="POST" action="{{ url('/create_cc_order_by_admin') }}" class="form-horizontal" role="form" >
                            {{ csrf_field() }}
