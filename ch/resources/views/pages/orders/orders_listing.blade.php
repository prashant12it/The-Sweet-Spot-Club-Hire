    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            <li class="crumb-active">
                <a href="{{url('/admin_orders')}}"><span class="glyphicon glyphicon-shopping-cart"></span> Orders</a>
            </li>
        </ol>
    </div>
</header>
<section id="content">
    <div class="panel">
        <form method="POST" enctype="multipart/form-data" action="{{ url('/search_order') }}" class="form-horizontal" role="form" id="account2">
                {{ csrf_field() }}
                <div class="panel-menu admin-form theme-primary">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="col-md-3">
                            <label for="filter-customer" class="field">
                                <input value="{{$searchOrder['filter_user']}}" id="filter-user" name="searchAry[filter_user]" class="gui-input" placeholder="Customer Name/Email" type="text">
                            </label>
                        </div>
                         <div class="col-md-2">
                             <a href="{{url('courier')}}" class="button form-control btn-success pull-right">
                        ...
                        <div class="col-md-1">
                            <a href="{{ url('/admin_orders') }}" class="button form-control btn-danger pull-right"><i class="fa fa-refresh" aria-hidden="true"></i> </a>
                        </div>
                    </div>
                </div>
        </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group text-right">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            @foreach ($statusAry as $status)
                                                @if ($status->id != $oderDetails->order_status && $status->id>1)
                                                    <li>
                                ...
                                <td>
                                    <div class="navbar-btn btn-group">
                                        <a href="{{ url('/view_orders') }}/{{$oderDetails->id}}" class="button form-control btn-info" title="View Order Details">
        ...
        <div class="modal fade" id="updateStatusModal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <form method="POST" action="{{ url('/update_order_status') }}" class="form-horizontal" role="form" >
                        {{ csrf_field() }}
